  ...
  return (
    <div className="py-4 flex gap-[6px] justify-between">
      <div className="flex flex-col bg-estoquei-bg2 rounded-lg py-[14px] px-3 w-full border border-estoquei-border">
        ...
        <span className="text-estoquei-text text-[22px] font-semibold leading-none mb-1" aria-label={`${total.quantity} itens no total`}>{total.quantity}</span>
      ...
      <div className="flex flex-col bg-estoquei-bg2 rounded-lg py-[14px] px-3 w-full border border-estoquei-border">
        ...
        <span className="text-estoquei-warning text-[22px] font-semibold leading-none mb-1" aria-label={`${lowStock.quantity} produtos com baixo estoque`}>{lowStock.quantity}</span>
      ...
      <div className="flex flex-col bg-estoquei-bg2 rounded-lg py-[14px] px-3 w-full border border-estoquei-border">
        ...
        <span className="text-estoquei-danger text-[22px] font-semibold leading-none mb-1" aria-label={`${outOfStockQuantity} produtos sem estoque`}>{outOfStockQuantity}</span>
